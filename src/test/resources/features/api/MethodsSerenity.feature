...
Feature: Test the API methods
  ...
  Scenario: Test GET method
    ...
    When I "GET" the endpoint with Serenity
    Then I verify the response

  @POST_METHOD
  Scenario: Test POST method
    Given I have a Body Request
    When I "POST" the endpoint with Serenity
    Then I verify the response

  @PUT_METHOD
  Scenario: Test PUT method
    Given I have a Body Request
    When I "PUT" the endpoint with Serenity
    Then I verify the response

  @PATCH_METHOD
  Scenario: Test PATCH method
    Given I have a Body Request
    When I "PATCH" the endpoint with Serenity
    Then I verify the response

  @DELETE_METHOD
  Scenario: Test DELETE method
    Given I have a Body Request
    When I "DELETE" the endpoint with Serenity
    Then I verify the response
